...
var TopicPublisher = function (topicName) {
    ...
    publisher.disconnect = function () {
     ...
     publisher.publish = function () {
        if (publisher.session !== null) {
            ...
            var messageText = name+","+email+","+messaget;
    ...
    // publisher.publishimage = function () {
    //     if (publisher.session !== null) {
    //         var image = document.getElementById('pic').value;
    //         var messageText = image;
    //         var message = solace.SolclientFactory.createMessage();
    //         message.setDestination(solace.SolclientFactory.createTopicDestination("test/image"));
    //         message.setBinaryAttachment(messageText);
    //         message.setDeliveryMode(solace.MessageDeliveryModeType.DIRECT);
    //         publisher.log('Publishing message "' + messageText + '" to topic "' + test/image + '"...');
    //         try {
    //             publisher.session.send(message);
    //             publisher.log('Message published.');
    //         } catch (error) {
